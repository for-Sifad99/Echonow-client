    ...
    return (
        <div className="flex flex-col items-center justify-center mx-auto dark:bg-[var(--dark-secondary)] bg-[var(--white)] rounded-xl shadow-md text-black p-4 w-full max-w-[440px] sm:max-w-full h-[240px] sm:h-[266px] md:h-[270px] lg:h-[267px] xl:h-[270px]">
            ...
            <div className="w-full flex justify-between">
                <h3 className="px-1 flex flex-col text-[13px] sm:text-[11px] font-semibold text-[var(--dark)] dark:text-[var(--white)] mb-2"><p className='-mb-1'>
                    Publication Articles</p>
                    <p>Distribution</p>
                </h3>
            ...
            <div className='relative w-full h-full'>
                <ResponsiveContainer width="100%" height={'100%'} className='relative'>
                    ...
                    <div className='font-medium text-[var(--accent)] dark:text-[var(--accent-white)] max-w-fit max-h-fit absolute top-[36%] left-[41%]'>
                        {data.map((entry, index) => (
