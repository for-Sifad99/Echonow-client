                    ...
                    >
                        ...
                        <div className="relative">
                            <img
                                src={pub.logo}
                                alt={pub.name}
                                className="w-full sm:h-28 sm:w-28 md:h-30 md:w-30 xl:h-36 xl:w-36 object-cover rounded blur-sm"
